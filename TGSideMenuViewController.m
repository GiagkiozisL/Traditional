...
@interface TGSideMenuViewController ()
...
@implementation TGSideMenuViewController
...
- (void)setSideMenuViewController:(TGSideMenuViewController *)sideMenuViewController {
    objc_setAssociatedObject(self, @selector(sideMenuViewController), sideMenuViewController, OBJC_ASSOCIATION_ASSIGN);
}

- (TGSideMenuViewController *)sideMenuViewController {
    TGSideMenuViewController *sideMenuController = objc_getAssociatedObject(self, @selector(sideMenuViewController));
